...
const classes = computed(() =>
    props.active
        ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary text-start text-base font-medium text-foreground bg-accent focus:outline-none transition duration-150 ease-in-out'
